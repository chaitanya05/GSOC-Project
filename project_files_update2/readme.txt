Download the OpenLayers compressed file from http://web.iiit.ac.in/~ponnathotasaichaitanya.reddy/project/OpenLayers-2.13.1.tar.gz
Extract the OpenLayers-2.13.1.tar.gz in your desired host address.
Download the files that you have submitted.
Then uncompress in the same folder as done for the OpenLayers file.
