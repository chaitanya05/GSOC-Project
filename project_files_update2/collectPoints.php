...
$(document).ready(function()
{
	...
	var d1 = document.getElementById('zoomInButton');
	d1.onclick = function(){ tempAlert("Wait for a few moments!!!",2000); };
	var d2 = document.getElementById('zoomOutButton');
	d2.onclick = function(){ tempAlert("Wait for a few moments!!!",2000); };
	var d3 = document.getElementById('topPositionMap');
	d3.onclick = function(){ tempAlert("Wait for a few moments!!!",2000); };
	var d4 = document.getElementById('leftPositionMap');
	d4.onclick = function(){ tempAlert("Wait for a few moments!!!",2000); };
	var d5 = document.getElementById('rightPositionMap');
	d5.onclick = function(){ tempAlert("Wait for a few moments!!!",2000); };
	var d6 = document.getElementById('bottomPositionMap');
...
<div>
	<div id="pageContent">
		...
		function tempAlert(msg,duration) {
			...
			el.setAttribute("style","position:absolute;top:13%;left:79%;width:150px;height:150px;background-color:white;");
			el.innerHTML = msg;
			setTimeout(function() {
